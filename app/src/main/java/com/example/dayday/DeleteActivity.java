...
public class DeleteActivity extends AppCompatActivity {
    ...
    DeleteAdapter adapter;//不会自动转化的么
    String uid;
    String cid;
    String adminId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete);//R.id 会在这里面查找，如果没有就会报错
        //传递信息
        ...
        //绑定，其实就是点击，然后跳转事件
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_delete);//修改1
        // 给recyclerView指定一个Linear线性布局
        LinearLayoutManager layoutManager = new LinearLayoutManager(DeleteActivity.this);
        recyclerView.setLayoutManager(layoutManager);
        adapter = new DeleteAdapter(list,DeleteActivity.this,uid);
...
//            for(int i=0;i<5;i++){
//                Log.d("ffflog","123"+i);
//                list.add(new UserCircle(cid,"123"+i,adminId,1,1));
//            }
        }
    }
}
